...
var AppService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [2 /*return*/, this._services.get(key)];
                }
            });
        });
    };
    AppService.prototype.set = function (key, createFn) {
        if (this._factories.has(key)) {
    ...
    AppService.prototype.setInstance = function (key, instance) {
        this._services.set(key, instance);
        return this;
    };
    Object.defineProperty(AppService.prototype, "services", {
        get: function () {
